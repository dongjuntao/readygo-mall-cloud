...
CREATE TABLE `evaluation`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `member_id` bigint(0) NULL DEFAULT NULL COMMENT '评价人id',
  `goods_id` bigint(0) NULL DEFAULT NULL COMMENT '商品id',
  `sku_id` bigint(0) NULL DEFAULT NULL COMMENT '商品skuId',
  `merchant_id` bigint(0) NULL DEFAULT NULL COMMENT '所属商户id',
  `logistics_evaluation_level` int(0) NULL DEFAULT NULL COMMENT '物流评价等级【1,2,3,4,5】(星)',
  `service_evaluation_level` int(0) NULL DEFAULT NULL COMMENT '服务评价等级【1,2,3,4,5】(星)',
  `description_evaluation_level` int(0) NULL DEFAULT NULL COMMENT '描述评价等级【1,2,3,4,5】(星)',
  `goods_evaluation_level` int(0) NULL DEFAULT NULL COMMENT '商品评价等级【1(差评),2(中评),3(好评)）',
  `evaluate_content` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '评价内容',
  `answer_content` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '回复内容',
  `images` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '评价图片(多个图片以逗号隔开)',
  `order_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '订单号',
  `sub_order_code` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '子订单号',
  `evaluate_time` datetime(0) NULL DEFAULT NULL COMMENT '评价时间',
  `answer_time` datetime(0) NULL DEFAULT NULL COMMENT '回复时间（商家）',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `evaluation` VALUES (1, 1, 14, 127, 5, 3, 2, 3, 2, '一般般', NULL, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/comment/pictures1692757760449364337brand.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/comment/pictures1692757762591518724goods-category.jpg', 'O1689182607700529152', 'S1689182608002519041', '2023-08-23 10:29:55', NULL);
...
CREATE TABLE `goods`  (
  ...
  `goods_status` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品状态',
  ...
  `total_sales` int(0) NULL DEFAULT NULL COMMENT '总销量（包括sku单品的所有销量之和）',
  `total_stock` int(0) NULL DEFAULT NULL COMMENT '总库存（包括sku单品的所有库存之和）',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of goods
-- ----------------------------
INSERT INTO `goods` VALUES (1, '【首降250元！指定时间点疯抢五折！】Xiaomi 12S Pro游戏徕卡拍照骁龙8+小米12spro官方旗舰店红米小米手机', '小米', 2, 8, 9, 46, 'ON_SALE', 1, '20229910', 1, '部', '【首降250元！指定时间点疯抢五折！】Xiaomi 12S Pro游戏徕卡拍照骁龙8+小米12spro官方旗舰店红米小米手机', 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662708207379263605xm1.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662708210385114717xm2.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662708213590954140xm3.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662708216780556283xm4.jpg', '', 1, '[]', 5, '最新商品', NULL, NULL, 0, NULL, '2022-04-10 17:46:55', '2022-09-09 15:23:49');
INSERT INTO `goods` VALUES (2, '当天发【24期免息】Mate 40E手机TD M40 5G官方旗舰店正品新款官网pro直降p50系列鸿蒙nova9 华5g为Huawei', '华为', 2, 8, 9, 46, 'ON_SALE', 1, '2100299331', 2, '部', '当天发【24期免息】Mate 40E手机TD M40 5G官方旗舰店正品新款官网pro直降p50系列鸿蒙nova9 华5g为Huawei', 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662707968307251352hw1.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662707971282442404hw2.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662707974322482067hw3.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662707977337254319hw4.jpg', '', 1, '[]', 5, '最新商品', NULL, NULL, 0, NULL, '2022-04-21 17:45:27', '2022-09-09 15:21:05');
INSERT INTO `goods` VALUES (3, '佳能5d4 EOS 5D Mark IV单机身专业级单反相机24-105f4 USM全画幅', '相机，单反', 2, 11, 12, 54, 'ON_SALE', 1, '202205011517', 4, '台', '佳能官方专卖店,全新原装正品国行', 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1651389491431421135O1CN01j2KxP61xmB4SNWvxP_!!0-item_pic.jpg_430x430q90.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/16513895119992898043.jpg', '<p>相机</p>', 1, '[]', 5, '推荐商品', NULL, NULL, 0, NULL, '2022-05-01 15:21:50', '2022-06-04 14:46:32');
INSERT INTO `goods` VALUES (4, 'HUAWEI MateBook 14 11代英特尔酷睿处理器 16GB+512GB SSD锐炬显卡笔记本轻薄办公电脑 2K触控护眼屏', '华为', 2, 15, 16, 65, 'ON_SALE', 1, '202205011604', 2, '台', '华为笔记本', 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1651392325988666282O1CN01N2AHiO28vIsuWewt5_!!725677994.jpg_430x430q90.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1651392330845277645O1CN01Xvvp1i1PMoMgk9fvR_!!0-item_pic.jpg_430x430q90.jpg', '<p>华为就是牛</p>', 1, '[]', 10, '最新商品,推荐商品,热卖商品', NULL, NULL, 0, NULL, '2022-05-01 16:07:42', '2022-09-09 15:25:45');
INSERT INTO `goods` VALUES (5, 'Apple 苹果 MacBook Air 2020新款', 'apple', 4, 15, 16, 65, 'ON_SALE', 1, '202205151450', 3, '台', '[套餐版]Apple 苹果 MacBook Air 2020新款 8核M1芯片 8G内存 512G固态 8核图形处理器 13.3英寸笔记本电脑 轻薄本 MGNA3CH/A 银色', 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1652597439343113694PFEFLnSQyU1651911291903.png', '<p>好电脑</p>', 1, '[]', 5, '最新商品,推荐商品', NULL, NULL, 0, NULL, '2022-05-15 14:52:30', '2022-06-04 14:45:53');
INSERT INTO `goods` VALUES (6, 'TCL 55V6E 55英寸 金属全面屏 2+16GB 低蓝光护眼 双频WiFi 超薄液晶55吋平板电视机 智慧屏', '电视', 2, 1, 2, 23, 'ON_SALE', 1, '202209042131', 5, '台', 'TCL 55V6E 55英寸 金属全面屏 2+16GB 低蓝光护眼 双频WiFi 超薄液晶55吋平板电视机 智慧屏', 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662357449767650389tcl1.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662357454197797420tcl2.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662357457503191783tcl3.jpg', '', 0, '[]', 0, '最新商品', NULL, NULL, 0, NULL, '2022-09-04 21:33:38', '2022-10-17 14:41:18');
INSERT INTO `goods` VALUES (7, '海尔电视55R5 55英寸4K超高清智能语音网络平板家用液晶电视机', '海尔，电视', 4, 1, 2, 23, 'ON_SALE', 1, '202209051438', 6, '台', '海尔电视55R5 55英寸4K超高清智能语音网络平板家用液晶电视机', 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662360409444240981000.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662360411697106148001.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662360415041823830002.jpg', '', 1, '[]', 0, '最新商品', NULL, NULL, 0, NULL, '2022-09-05 14:40:06', '2022-10-17 14:41:00');
INSERT INTO `goods` VALUES (8, '【新国标】格力空调大1.5p匹变频挂机冷暖家用官方旗舰店官网天丽', '格力', 2, 1, 3, 27, 'ON_SALE', 1, '202209082143', 7, '台', '【新国标】格力空调大1.5p匹变频挂机冷暖家用官方旗舰店官网天丽', 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662644613548832606geli1.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662644616942642479geli2.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662644620738905574geli3.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662644623715422494geli4.jpg', '', 0, '[]', 0, '最新商品,推荐商品,热卖商品', NULL, NULL, 0, NULL, '2022-09-08 21:44:40', '2022-10-17 14:40:40');
INSERT INTO `goods` VALUES (9, '格力滚筒洗衣机全自动家用8公斤kg大容量智能变频轻音烘洗一体机', '格力', 4, 1, 4, 30, 'ON_SALE', 1, '202209091420', 7, '台', '格力滚筒洗衣机全自动家用8公斤kg大容量智能变频轻音烘洗一体机', 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662704522044926109geli1.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662704524981669674geli2.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662704528864176013geli3.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662704531747841889geli4.jpg', '', 0, '[]', 0, '最新商品,推荐商品,特价商品,热卖商品', NULL, NULL, 0, NULL, '2022-09-09 14:23:07', '2022-10-17 14:40:13');
INSERT INTO `goods` VALUES (10, '格力晶弘 变频冰箱 529升对开门风冷无霜-33度深冷冻BCD-529WPDC', '格力', 4, 1, 5, 35, 'ON_SALE', 1, '202209091425', 7, '台', '格力晶弘 变频冰箱 529升对开门风冷无霜-33度深冷冻BCD-529WPDC', 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662704789925958264geli1.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662704792647113753geli2.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662704795667436863geli3.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662704798607120128geli4.jpg', '', 0, '[]', 5, '特价商品,热卖商品', NULL, NULL, 0, NULL, '2022-09-09 14:27:40', '2022-10-17 14:39:51');
INSERT INTO `goods` VALUES (11, '格力（GREE）抽油烟机 塔型大油烟机大吸力/大风压/低噪油烟机', '格力', 2, 1, 6, 38, 'ON_SALE', 1, '202209091430', 7, '台', '格力（GREE）抽油烟机 塔型大油烟机大吸力/大风压/低噪油烟机', 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662705045933241285geli1.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662705049491984326geli2.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662705052660378908geli3.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662705056336981286geli4.jpg', '', 0, '[]', 0, '最新商品', NULL, NULL, 0, NULL, '2022-09-09 14:31:41', '2022-10-17 14:39:02');
INSERT INTO `goods` VALUES (12, '小米米家胶囊咖啡机家用全自动小型研磨一体迷你胶囊机办公煮咖啡', '小米', 3, 1, 7, 43, 'ON_SALE', 1, '202209091434', 1, '台', '小米米家胶囊咖啡机家用全自动小型研磨一体迷你胶囊机办公煮咖啡', 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662705323526413895xm4.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662705327333982989xm1.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662705331316706642xm2.jpg,https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/images/1662705334723327533xm3.jpg', '', 0, '[]', 0, '最新商品,推荐商品,特价商品,热卖商品', NULL, NULL, 0, NULL, '2022-09-09 14:36:21', '2022-10-17 14:38:42');
...
CREATE TABLE `goods_sku`  (
  ...
  `sales` int(0) NULL DEFAULT NULL COMMENT '单品销量',
...
-- ----------------------------
INSERT INTO `goods_sku` VALUES (73, 5, '2022051501', 9399.00, 8799.00, 496, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/1652597528758451679PFEFLnSQyU1651911291903.png', NULL, '[{\"id\":2,\"name\":\"内存\",\"specificationsDetailList\":[{\"id\":12,\"value\":\"12G+128G\"},{\"id\":11,\"value\":\"8G+256G\"}]},{\"id\":3,\"name\":\"颜色\",\"specificationsDetailList\":[{\"id\":14,\"value\":\"红色\"},{\"id\":19,\"value\":\"蓝色\"}]}]', '[{\"id\":12,\"value\":\"12G+128G\"},{\"id\":14,\"value\":\"红色\"}]');
INSERT INTO `goods_sku` VALUES (74, 5, '2022051502', 9599.00, 8999.00, 500, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/1652597531447570304PFEFLnSQyU1651911291903.png', NULL, '[{\"id\":2,\"name\":\"内存\",\"specificationsDetailList\":[{\"id\":12,\"value\":\"12G+128G\"},{\"id\":11,\"value\":\"8G+256G\"}]},{\"id\":3,\"name\":\"颜色\",\"specificationsDetailList\":[{\"id\":14,\"value\":\"红色\"},{\"id\":19,\"value\":\"蓝色\"}]}]', '[{\"id\":12,\"value\":\"12G+128G\"},{\"id\":19,\"value\":\"蓝色\"}]');
INSERT INTO `goods_sku` VALUES (75, 5, '2022051503', 10999.00, 9999.00, 398, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/1652597533765523084PFEFLnSQyU1651911291903.png', NULL, '[{\"id\":2,\"name\":\"内存\",\"specificationsDetailList\":[{\"id\":12,\"value\":\"12G+128G\"},{\"id\":11,\"value\":\"8G+256G\"}]},{\"id\":3,\"name\":\"颜色\",\"specificationsDetailList\":[{\"id\":14,\"value\":\"红色\"},{\"id\":19,\"value\":\"蓝色\"}]}]', '[{\"id\":11,\"value\":\"8G+256G\"},{\"id\":14,\"value\":\"红色\"}]');
INSERT INTO `goods_sku` VALUES (76, 5, '2022051504', 10889.00, 9880.00, 800, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/1652597536725818750PFEFLnSQyU1651911291903.png', NULL, '[{\"id\":2,\"name\":\"内存\",\"specificationsDetailList\":[{\"id\":12,\"value\":\"12G+128G\"},{\"id\":11,\"value\":\"8G+256G\"}]},{\"id\":3,\"name\":\"颜色\",\"specificationsDetailList\":[{\"id\":14,\"value\":\"红色\"},{\"id\":19,\"value\":\"蓝色\"}]}]', '[{\"id\":11,\"value\":\"8G+256G\"},{\"id\":19,\"value\":\"蓝色\"}]');
INSERT INTO `goods_sku` VALUES (81, 3, '2022050101', 12999.00, 11999.00, 5000, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/1652600178530665807RuVkd5CO5ICXFV2QovpvaQ.png', NULL, '[{\"id\":3,\"name\":\"颜色\",\"specificationsDetailList\":[{\"id\":14,\"value\":\"红色\"},{\"id\":19,\"value\":\"蓝色\"}]},{\"id\":2,\"name\":\"内存\",\"specificationsDetailList\":[{\"id\":4,\"value\":\"4G+32G\"},{\"id\":5,\"value\":\"4G+64G\"}]}]', '[{\"id\":14,\"value\":\"红色\"},{\"id\":4,\"value\":\"4G+32G\"}]');
INSERT INTO `goods_sku` VALUES (82, 3, '2022050102', 13999.00, 12999.00, 3000, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/1652600182482789415RuVkd5CO5ICXFV2QovpvaQ.png', NULL, '[{\"id\":3,\"name\":\"颜色\",\"specificationsDetailList\":[{\"id\":14,\"value\":\"红色\"},{\"id\":19,\"value\":\"蓝色\"}]},{\"id\":2,\"name\":\"内存\",\"specificationsDetailList\":[{\"id\":4,\"value\":\"4G+32G\"},{\"id\":5,\"value\":\"4G+64G\"}]}]', '[{\"id\":14,\"value\":\"红色\"},{\"id\":5,\"value\":\"4G+64G\"}]');
INSERT INTO `goods_sku` VALUES (83, 3, '2022050103', 11999.00, 11799.00, 5000, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/1652600185377725796RuVkd5CO5ICXFV2QovpvaQ.png', NULL, '[{\"id\":3,\"name\":\"颜色\",\"specificationsDetailList\":[{\"id\":14,\"value\":\"红色\"},{\"id\":19,\"value\":\"蓝色\"}]},{\"id\":2,\"name\":\"内存\",\"specificationsDetailList\":[{\"id\":4,\"value\":\"4G+32G\"},{\"id\":5,\"value\":\"4G+64G\"}]}]', '[{\"id\":19,\"value\":\"蓝色\"},{\"id\":4,\"value\":\"4G+32G\"}]');
INSERT INTO `goods_sku` VALUES (84, 3, '2022050104', 14999.00, 12999.00, 7000, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/1652600188259389140RuVkd5CO5ICXFV2QovpvaQ.png', NULL, '[{\"id\":3,\"name\":\"颜色\",\"specificationsDetailList\":[{\"id\":14,\"value\":\"红色\"},{\"id\":19,\"value\":\"蓝色\"}]},{\"id\":2,\"name\":\"内存\",\"specificationsDetailList\":[{\"id\":4,\"value\":\"4G+32G\"},{\"id\":5,\"value\":\"4G+64G\"}]}]', '[{\"id\":19,\"value\":\"蓝色\"},{\"id\":5,\"value\":\"4G+64G\"}]');
INSERT INTO `goods_sku` VALUES (113, 2, '2022011122', 4999.00, 3999.00, 96, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/1652599971761640690Qzc-AnSXiWhJKiZIejeadQ.jpg', NULL, '[{\"id\":2,\"name\":\"内存\",\"specificationsDetailList\":[{\"id\":8,\"value\":\"6G+128G\"},{\"id\":9,\"value\":\"6G+256G\"}]},{\"id\":3,\"name\":\"颜色\",\"specificationsDetailList\":[{\"id\":14,\"value\":\"红色\"},{\"id\":19,\"value\":\"蓝色\"}]}]', '[{\"id\":8,\"value\":\"6G+128G\"},{\"id\":14,\"value\":\"红色\"}]');
INSERT INTO `goods_sku` VALUES (114, 2, '2022011123', 4999.00, 4888.00, 200, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/1652599975229412779Qzc-AnSXiWhJKiZIejeadQ.jpg', NULL, '[{\"id\":2,\"name\":\"内存\",\"specificationsDetailList\":[{\"id\":8,\"value\":\"6G+128G\"},{\"id\":9,\"value\":\"6G+256G\"}]},{\"id\":3,\"name\":\"颜色\",\"specificationsDetailList\":[{\"id\":14,\"value\":\"红色\"},{\"id\":19,\"value\":\"蓝色\"}]}]', '[{\"id\":8,\"value\":\"6G+128G\"},{\"id\":19,\"value\":\"蓝色\"}]');
INSERT INTO `goods_sku` VALUES (115, 2, '2022011124', 6999.00, 6299.00, 500, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/1652599978108746218Qzc-AnSXiWhJKiZIejeadQ.jpg', NULL, '[{\"id\":2,\"name\":\"内存\",\"specificationsDetailList\":[{\"id\":8,\"value\":\"6G+128G\"},{\"id\":9,\"value\":\"6G+256G\"}]},{\"id\":3,\"name\":\"颜色\",\"specificationsDetailList\":[{\"id\":14,\"value\":\"红色\"},{\"id\":19,\"value\":\"蓝色\"}]}]', '[{\"id\":9,\"value\":\"6G+256G\"},{\"id\":14,\"value\":\"红色\"}]');
INSERT INTO `goods_sku` VALUES (116, 2, '2022011125', 7999.00, 6999.00, 1000, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/1652599980695257207Qzc-AnSXiWhJKiZIejeadQ.jpg', NULL, '[{\"id\":2,\"name\":\"内存\",\"specificationsDetailList\":[{\"id\":8,\"value\":\"6G+128G\"},{\"id\":9,\"value\":\"6G+256G\"}]},{\"id\":3,\"name\":\"颜色\",\"specificationsDetailList\":[{\"id\":14,\"value\":\"红色\"},{\"id\":19,\"value\":\"蓝色\"}]}]', '[{\"id\":9,\"value\":\"6G+256G\"},{\"id\":19,\"value\":\"蓝色\"}]');
INSERT INTO `goods_sku` VALUES (117, 1, '2022100022', 2999.00, 2699.00, 996, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/1652599892005820252Qzc-AnSXiWhJKiZIejeadQ.jpg', NULL, '[{\"id\":2,\"name\":\"内存\",\"specificationsDetailList\":[{\"id\":8,\"value\":\"6G+128G\"},{\"id\":9,\"value\":\"6G+256G\"}]},{\"id\":3,\"name\":\"颜色\",\"specificationsDetailList\":[{\"id\":14,\"value\":\"红色\"},{\"id\":16,\"value\":\"黄色\"}]}]', '[{\"id\":8,\"value\":\"6G+128G\"},{\"id\":14,\"value\":\"红色\"}]');
INSERT INTO `goods_sku` VALUES (118, 1, '2022100023', 2999.00, 2799.00, 2000, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/1652599895934881378Qzc-AnSXiWhJKiZIejeadQ.jpg', NULL, '[{\"id\":2,\"name\":\"内存\",\"specificationsDetailList\":[{\"id\":8,\"value\":\"6G+128G\"},{\"id\":9,\"value\":\"6G+256G\"}]},{\"id\":3,\"name\":\"颜色\",\"specificationsDetailList\":[{\"id\":14,\"value\":\"红色\"},{\"id\":16,\"value\":\"黄色\"}]}]', '[{\"id\":8,\"value\":\"6G+128G\"},{\"id\":16,\"value\":\"黄色\"}]');
INSERT INTO `goods_sku` VALUES (119, 1, '2022100024', 2999.00, 2899.00, 5000, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/1652599901133716088Qzc-AnSXiWhJKiZIejeadQ.jpg', NULL, '[{\"id\":2,\"name\":\"内存\",\"specificationsDetailList\":[{\"id\":8,\"value\":\"6G+128G\"},{\"id\":9,\"value\":\"6G+256G\"}]},{\"id\":3,\"name\":\"颜色\",\"specificationsDetailList\":[{\"id\":14,\"value\":\"红色\"},{\"id\":16,\"value\":\"黄色\"}]}]', '[{\"id\":9,\"value\":\"6G+256G\"},{\"id\":14,\"value\":\"红色\"}]');
INSERT INTO `goods_sku` VALUES (120, 1, '2022100025', 2999.00, 2999.00, 10000, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/1652599904162425342Qzc-AnSXiWhJKiZIejeadQ.jpg', NULL, '[{\"id\":2,\"name\":\"内存\",\"specificationsDetailList\":[{\"id\":8,\"value\":\"6G+128G\"},{\"id\":9,\"value\":\"6G+256G\"}]},{\"id\":3,\"name\":\"颜色\",\"specificationsDetailList\":[{\"id\":14,\"value\":\"红色\"},{\"id\":16,\"value\":\"黄色\"}]}]', '[{\"id\":9,\"value\":\"6G+256G\"},{\"id\":16,\"value\":\"黄色\"}]');
INSERT INTO `goods_sku` VALUES (121, 4, '2022050101', 4999.00, 4899.00, 990, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/1652600106407320786t-gvMHnbgVq9ZzL2HItykA.jpg', NULL, '[{\"id\":3,\"name\":\"颜色\",\"specificationsDetailList\":[{\"id\":19,\"value\":\"蓝色\"},{\"id\":14,\"value\":\"红色\"}]},{\"id\":2,\"name\":\"内存\",\"specificationsDetailList\":[{\"id\":12,\"value\":\"12G+128G\"},{\"id\":13,\"value\":\"12G+256G\"}]}]', '[{\"id\":19,\"value\":\"蓝色\"},{\"id\":12,\"value\":\"12G+128G\"}]');
INSERT INTO `goods_sku` VALUES (122, 4, '2022050102', 5999.00, 5899.00, 2000, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/1652600102441967862t-gvMHnbgVq9ZzL2HItykA.jpg', NULL, '[{\"id\":3,\"name\":\"颜色\",\"specificationsDetailList\":[{\"id\":19,\"value\":\"蓝色\"},{\"id\":14,\"value\":\"红色\"}]},{\"id\":2,\"name\":\"内存\",\"specificationsDetailList\":[{\"id\":12,\"value\":\"12G+128G\"},{\"id\":13,\"value\":\"12G+256G\"}]}]', '[{\"id\":19,\"value\":\"蓝色\"},{\"id\":13,\"value\":\"12G+256G\"}]');
INSERT INTO `goods_sku` VALUES (123, 4, '2022050103', 6999.00, 6799.00, 2000, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/1652600114335703617t-gvMHnbgVq9ZzL2HItykA.jpg', NULL, '[{\"id\":3,\"name\":\"颜色\",\"specificationsDetailList\":[{\"id\":19,\"value\":\"蓝色\"},{\"id\":14,\"value\":\"红色\"}]},{\"id\":2,\"name\":\"内存\",\"specificationsDetailList\":[{\"id\":12,\"value\":\"12G+128G\"},{\"id\":13,\"value\":\"12G+256G\"}]}]', '[{\"id\":14,\"value\":\"红色\"},{\"id\":12,\"value\":\"12G+128G\"}]');
INSERT INTO `goods_sku` VALUES (124, 4, '2022050104', 7999.00, 7599.00, 5000, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/1652600129160402647t-gvMHnbgVq9ZzL2HItykA.jpg', NULL, '[{\"id\":3,\"name\":\"颜色\",\"specificationsDetailList\":[{\"id\":19,\"value\":\"蓝色\"},{\"id\":14,\"value\":\"红色\"}]},{\"id\":2,\"name\":\"内存\",\"specificationsDetailList\":[{\"id\":12,\"value\":\"12G+128G\"},{\"id\":13,\"value\":\"12G+256G\"}]}]', '[{\"id\":14,\"value\":\"红色\"},{\"id\":13,\"value\":\"12G+256G\"}]');
INSERT INTO `goods_sku` VALUES (125, 15, '202209091451', 59.00, 52.00, 995, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/16658995561179078561662706258126462289xm1.jpg', NULL, '[{\"id\":3,\"name\":\"颜色\",\"specificationsDetailList\":[{\"id\":20,\"value\":\"紫色\"},{\"id\":19,\"value\":\"蓝色\"}]}]', '[{\"id\":20,\"value\":\"紫色\"}]');
INSERT INTO `goods_sku` VALUES (126, 15, '202209091451', 69.00, 62.00, 800, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/16658995609046533491662706258126462289xm1.jpg', NULL, '[{\"id\":3,\"name\":\"颜色\",\"specificationsDetailList\":[{\"id\":20,\"value\":\"紫色\"},{\"id\":19,\"value\":\"蓝色\"}]}]', '[{\"id\":19,\"value\":\"蓝色\"}]');
INSERT INTO `goods_sku` VALUES (127, 14, '202209091446', 799.00, 599.00, 294, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/16659866843565675411111.jpg', NULL, NULL, NULL);
INSERT INTO `goods_sku` VALUES (128, 13, '202209091442', 138.00, 69.00, 4998, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/16659886962939813931662705689912137118dly1.jpg', NULL, NULL, NULL);
INSERT INTO `goods_sku` VALUES (129, 12, '202209091435', 349.00, 349.00, 1999, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/16659887199958373681662705323526413895xm4.jpg', NULL, NULL, NULL);
INSERT INTO `goods_sku` VALUES (130, 11, '202209091432', 5399.00, 5399.00, 199, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/16659887401475960331662705045933241285geli1.jpg', NULL, NULL, NULL);
INSERT INTO `goods_sku` VALUES (131, 10, '202209091426', 4299.00, 3599.00, 4999, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/16659887884931956311662704789925958264geli1.jpg', NULL, NULL, NULL);
INSERT INTO `goods_sku` VALUES (132, 9, '202209091422', 5999.00, 5999.00, 2000, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/16659888105563184121662704522044926109geli1.jpg', NULL, NULL, NULL);
INSERT INTO `goods_sku` VALUES (133, 8, '202209082143', 3199.00, 2899.00, 598, 1, 'https://dongjuntao-1303976517.cos.ap-shanghai.myqcloud.com/goods/sku/images/16659888332878630641662644613548832606geli1.jpg', NULL, NULL, NULL);
