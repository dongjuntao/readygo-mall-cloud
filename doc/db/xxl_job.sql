...
-- ----------------------------
INSERT INTO `xxl_job_group` VALUES (1, 'xxl-job-executor-sample', '示例执行器', 0, NULL, '2023-03-08 15:25:22');
INSERT INTO `xxl_job_group` VALUES (2, 'mall-goods-executor', '商品服务', 1, 'http://192.168.137.1:9988', '2023-03-06 17:34:27');
...
INSERT INTO `xxl_job_info` VALUES (2, 2, '测试任务1', '2023-03-06 16:07:08', '2023-03-07 12:50:55', '董俊涛', '', 'CRON', '*/5 * * * * ?', 'DO_NOTHING', 'FIRST', 'myJobHandler', '', 'SERIAL_EXECUTION', 0, 0, 'BEAN', '', 'GLUE代码初始化', '2023-03-06 16:07:08', '', 0, 0, 0);
