...
import com.mall.order.vo.PayGoodsVO;
import com.mall.order.vo.PayMerchantVO;
 ...
 */
@Service
public class PayInfoGoodsServiceImpl implements PayInfoGoodsService {
    ...
    @Override
    public PayVO getPayInfoGoods(Map<String, Object> params) {
        ...
        if (CartTypeEnum.BUY_NOW.name().equals(cartType)) {
            ...
            CommonResult cartListResult = feignCartService.list(JSON.toJSONString(CurrentUserContextUtil.getCurrentUserInfo()));
