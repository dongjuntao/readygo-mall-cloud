...
import com.mall.log.mapper.RabbitMQReceivedLogMapper;
 ...
 */
@Service
public class RabbitMQReceivedLogServiceImpl extends ServiceImpl<RabbitMQReceivedLogMapper, RabbitMQReceivedLogEntity>
        implements RabbitMQReceivedLogService {
}
